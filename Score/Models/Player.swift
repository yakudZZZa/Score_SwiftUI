...
class Player: ObservableObject, Identifiable, Codable {
    enum CodingKeys: CodingKey {
        case id, name, score, selectedColorIndex
    }
    ...
    required init(from decoder: Decoder) throws {
        ...
        selectedColorIndex = try container.decode(Int.self, forKey: .selectedColorIndex)
    }
    
    init(score: Int, selectedColorIndex: Int) {
        self.score = score
        self.selectedColorIndex = selectedColorIndex
    }
    
    init(name: String, score: Int, selectedColorIndex: Int) {
        self.name = name
        self.score = score
        self.selectedColorIndex = selectedColorIndex
    }
    ...
    func encode(to encoder: Encoder) throws {
        ...
        try container.encode(selectedColorIndex, forKey: .selectedColorIndex)
    }
